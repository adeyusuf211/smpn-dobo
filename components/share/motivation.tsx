export default function MotivationComponent() {
  return (
    <div className="bg-blue-700 w-full h-full p-4 my-10 flex flex-col gap-5">
      <div className="flex gap-3">
        <div className="min-w-32 w-full min-h-32 h-full bg-blue-200 flex justify-center items-center">
